...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { company_id: @inquiry.company_id, house_id: @inquiry.house_id, message: @inquiry.message, subject: @inquiry.subject, user_id: @inquiry.user_id } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { company_id: @inquiry.company_id, house_id: @inquiry.house_id, message: @inquiry.message, subject: @inquiry.subject, user_id: @inquiry.user_id } }
